...
int COption::LoadToolTip( LPCTSTR szFileName )
{
	...
	do
	{
		...
		else if( scan.Token == _T( "무기추가옵션1" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[0] = D3DCOLOR_ARGB( 255, nR, nG, nB );			// 무기추가옵션1				
		}
		else if( scan.Token == _T( "무기추가옵션2" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[1] = D3DCOLOR_ARGB(255, nR, nG, nB);			// 무기추가옵션2
		}
		else if( scan.Token == _T( "무기추가옵션3" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[2] = D3DCOLOR_ARGB(255, nR, nG, nB);			// 무기추가옵션3
		}
		else if( scan.Token == _T( "무기추가옵션4" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[3] = D3DCOLOR_ARGB(255, nR, nG, nB);			// 무기추가옵션4
		}
		else if( scan.Token == _T( "무기추가옵션5" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[4] = D3DCOLOR_ARGB(255, nR, nG, nB);			// 무기추가옵션5
		}
		else if( scan.Token == _T( "무기추가옵션6" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[5] = D3DCOLOR_ARGB(255, nR, nG, nB);			// 무기추가옵션6
		}
		else if( scan.Token == _T( "무기추가옵션7" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[6] = D3DCOLOR_ARGB(255, nR, nG, nB);			// 무기추가옵션7
		}
		else if( scan.Token == _T( "무기추가옵션8" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[7] = D3DCOLOR_ARGB(255, nR, nG, nB);			// 무기추가옵션8
		}
		else if( scan.Token == _T( "무기추가옵션9" ) )
		{
			...
			nG = scan.GetNumber();
			nB = scan.GetNumber();
			g_WndMng.dwItemColor[m_nToolTipText].dwAddedOpt[8] = D3DCOLOR_ARGB(255, nR, nG, nB);			// 무기추가옵션9
		}
