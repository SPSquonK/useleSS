...
//EMPTY_WNDCLASSMEMBER( CWndFriend, _T( "ģ��" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndClub, _T( "Ŭ��" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndMessage, _T( "�Ž���" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndEMail, _T( "�̸���" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndBBS, _T( "�Խ���" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndSearchPeople, _T( "���ã��?" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndSearchGuild, _T( "���ã��?" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndSearchClub, _T( "Ŭ��ã��" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndSearchShop, _T( "����ã��" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndInfoEvent, _T( "�̺�Ʈ" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndJoinVote, _T( "������ǥ" ) )
...
//EMPTY_WNDCLASSMEMBER( CWndJoinEvent, _T( "�̺�Ʈ ���� ��û" ) )
