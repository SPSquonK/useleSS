...
CDPCoreClient::CDPCoreClient() {
	m_handlers.AddHandler( PACKETTYPE_QUERYTICKCOUNT, &CDPCoreClient::OnQueryTickCount );
	m_handlers.AddHandler( PACKETTYPE_PRE_JOIN      , &CDPCoreClient::OnPreJoin );
	m_handlers.AddHandler( PACKETTYPE_DESTROY_PLAYER, &CDPCoreClient::OnQueryRemovePlayer );
}
