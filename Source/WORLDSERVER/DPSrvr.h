...
private:
	...
	void	OnRevival( CAr & ar, DPID dpidCache, DPID dpidUser );
	void	OnRevivalLodestar( CAr & ar, DPID dpidCache, DPID dpidUser );
	void	OnRevivalLodelight( CAr & ar, DPID dpidCache, DPID dpidUser ); 
	void	OnSetLodelight( CAr & ar, DPID dpidCache, DPID dpidUser );
	...
	void	OnCorrReq( CAr & ar, DPID dpidCache, DPID dpidUser );
	void	OnCreateGuildCloak( CAr & ar, DPID dpidCache, DPID dpidUser );
	void	OnQueryGetPos( CAr & ar, DPID dpidCache, DPID dpidUser );
	void	OnGetPos( CAr & ar, DPID dpidCache, DPID dpidUser );
	void	OnQueryGetDestObj( CAr & ar, DPID dpidCache, DPID dpidUser );
	void	OnGetDestObj( CAr & ar, DPID dpidCache, DPID dpidUser );
