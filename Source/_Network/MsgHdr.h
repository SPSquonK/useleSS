...
#define PACKETTYPE_MODIFYTASKBAR (DWORD)0xffffff0a
...
#define PACKETTYPE_ADDPARTYMEMBER_NeuzCore		(DWORD)0xffffff11
#define PACKETTYPE_ADDPARTYMEMBER_CoreWorld		(DWORD)0xffffff11
#define PACKETTYPE_REMOVEPARTYMEMBER_NeuzCore	(DWORD)0xffffff12
#define PACKETTYPE_REMOVEPARTYMEMBER_CoreWorld	(DWORD)0xffffff12
...
#define PACKETTYPE_NC_ADDFRIEND		(DWORD)0xffffff60
#define PACKETTYPE_CW_ADDFRIEND		(DWORD)0xffffff60
...
#define	SNAPSHOTTYPE_UPDATE_ITEM_VARIANT		(WORD)0x0140
